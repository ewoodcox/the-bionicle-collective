...
import { manifest } from './manifest_BGObbzBY.mjs';
...
const _page9 = () => import('./pages/api/suggestions/_id_/vote.astro.mjs');
const _page10 = () => import('./pages/api/suggestions/_id_.astro.mjs');
const _page11 = () => import('./pages/api/suggestions.astro.mjs');
const _page12 = () => import('./pages/collection/_id_.astro.mjs');
const _page13 = () => import('./pages/collection.astro.mjs');
const _page14 = () => import('./pages/community.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/suggestions/[id]/vote.ts", _page9],
    ["src/pages/api/suggestions/[id].ts", _page10],
    ["src/pages/api/suggestions/index.ts", _page11],
    ["src/pages/collection/[id].astro", _page12],
    ["src/pages/collection/index.astro", _page13],
    ["src/pages/community/index.astro", _page14],
