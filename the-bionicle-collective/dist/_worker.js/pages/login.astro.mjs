...
import { $ as $$Layout } from '../chunks/Layout_CduOsoQc.mjs';
export { renderers } from '../renderers.mjs';

const $$Login = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Admin login | The Bionicle Collective", "description": "Admin login for collection edits." }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="login-page"> <h1>Admin login</h1> <p>Enter your admin secret to edit "In my Collection" on set pages.</p> <form id="login-form" class="login-form"> <label for="secret" class="login-label">Secret</label> <input type="password" id="secret" name="secret" class="login-input" autocomplete="current-password" required> <button type="submit" class="button-primary">Log in</button> </form> <p id="login-error" class="login-error" aria-live="polite" hidden></p> </div> ${renderScript($$result2, "/Users/ethan/Library/Mobile Documents/com~apple~CloudDocs/Development/the-bionicle-collective/src/pages/login.astro?astro&type=script&index=0&lang.ts")} ` })}`;
}, "/Users/ethan/Library/Mobile Documents/com~apple~CloudDocs/Development/the-bionicle-collective/src/pages/login.astro", void 0);

const $$file = "/Users/ethan/Library/Mobile Documents/com~apple~CloudDocs/Development/the-bionicle-collective/src/pages/login.astro";
const $$url = "/login";
